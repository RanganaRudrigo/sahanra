...
<head>
    ...
    <!-- Efinance Title -->
    <title>Sahanra Capital Corporation Limited</title>
    <!-- css file -->
    <link rel="stylesheet" href="css/bootstrap.min.css">
    <link rel="stylesheet" href="css/style.css">
    <link rel="stylesheet" href="css/menuzord-border-bottom.css"  />
    ...
    <link rel="stylesheet" type="text/css" href="css/timecounter.css">
    <link rel="stylesheet" type="text/css" href="css/fancyBox.css">
    <link rel="stylesheet" type="text/css" href="css/prettyphoto.css">
    <link rel="stylesheet" type="text/css" href="css/jquery.mCustomScrollbar.min.css">
    <link rel="stylesheet" type="text/css" href="css/jquery.circliful.css">
    <link rel="stylesheet" type="text/css" href="css/fonticon-et-line.css">
    <link rel="stylesheet" type="text/css" href="css/fonticon-linearicons.css">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="my-about-col">
                    ...
                    <div class="my-center-img">
                        <img class="img-responsive my-img-fluided" src="images/about-1.jpg" alt="">
                    </div>
            ...
            <div class="col-sm-12 col-md-5">
                <div class="my-about-col">
                    ...
                    <p>Magni facilis asperiores ullam! Cum dicta nulla suscipit veniam consequuntur, qui quaerat illo <a
                            href="#">voluptatum ipsum</a> eveniet in placeat possimus doloribus dolorum? Tenetur impedit
                        repellat.</p>
                    <ul class="my-about-list">
                        <li><a href="#">Molestiae repellendus unde praesentium </a></li>
                        <li><a href="#">Odi dicta, saepe obcaecati </a></li>
                        <li><a href="#">Eveniet, autem eligendi alias </a></li>
                        <li><a href="#">Possimus odit corporis est assumenda! </a></li>
                        <li><a href="#">Perspiciatis temporibus at odit </a></li>
                        <li><a href="#">voluptatem quod, ex dolore </a></li>
                    </ul>
