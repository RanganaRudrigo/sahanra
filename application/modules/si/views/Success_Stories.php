                ...
                <div class="col-sm-6">
                    <div class="my-inner-heading-col head-text">
                        ...
                        <ul>
                            ...
                            <li><a href="#">/</a></li>
                            <li><a href="#" class="active"> Success Stories </a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <?php foreach ($stories as $story): ?>
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="my-team-col">
                            <div class="thumb">
                                <img class="img-responsive my-img-fluided" src="<?= UP.$story->Image ?>"" alt="">
                                <div class="layer"></div>
                                <div class="thumb-content">
                                    <h4 class="title text-uppercase"><?=  $story->StoryTitle ?></h4>

                                </div>
                            </div>
                            <div class="content">
                                <p>  <?=  character_limiter($story->ShortDescription,200) ?></p>
                                <a class="efinance-color" href="<?= current_url()."/". url_title($story->StoryTitle)."/$story->StoryId" ?>">read more <i class="lnr lnr-arrow-right" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
