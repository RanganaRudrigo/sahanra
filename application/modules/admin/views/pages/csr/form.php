...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">CSR</h4>
                        <ol class="breadcrumb p-0">
                            <li><a href="<?= base_url('admin') ?>">Dashboard</a></li>
                            <li><a href="<?= base_url('admin/crs') ?>"> CSR</a></li>
                            <li class="active"> CSR <?= empty($obj->CSRId)?"Create":"Edit" ?> </li>
                        </ol>
            ...
            <div class="row">
                <div class="col-lg-12" > <a href="<?= base_url('admin/csr') ?>" class="fa fa-plus btn btn-primary pull-right m_b_10" > Add New </a> </div>
            </div>
            <div class="row">
                <div class="col-lg-8">
                    <?= form_open() ?>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group" >
                                                ...
                                                <input type="text" id="CSRTitle" name="form[CSRTitle]"
                                                       value="<?= $obj->CSRTitle ?>"
                                                       class="form-control" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6" >
                                            <div class="form-group">
                                                <label> CSR Default Image  <small> image size ( 570px * 686px ) </small>  </label>
                                            </div>
                ...
                <div class="col-lg-4" >
                    <div class="card-box">
                        <h4 class="header-title m-t-0 m-b-30  ">CSR List </h4>

                        <div class="record-list" >
                            <ol id="sortable" >
                                <?php foreach ($records as $record): ?>
                                    <li id="row_<?= $record->CSRId ?>" > <a href="<?= base_url("admin/$this->controller/index/$record->CSRId") ?>" class="" ><?= $record->CSRTitle ?>
                                            <i href="<?= base_url("admin/$this->controller/delete/$record->CSRId") ?>" class="delete-btn fa fa-times pull-right " ></i>  </a> </li>
                                <?php endforeach; ?>
                            </ol>
                        </div>
                    </div>
