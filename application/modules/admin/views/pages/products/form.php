...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12" > <a href="<?= base_url('admin/product') ?>" class="fa fa-plus btn btn-primary pull-right m_b_10" > Add New </a> </div>
            </div>
            <div class="row">
                <div class="col-lg-8">
                    <?= form_open() ?>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group" >
                                                ...
                                                <input type="text" id="ProductTitle" name="form[ProductTitle]"
                        ...
                        <div class="record-list" >
                            <ol id="sortable" >
                                <?php foreach ($records as $record): ?>
                                    <li id="row_<?= $record->ProductId ?>" > <a href="<?= base_url("admin/$this->controller/index/$record->ProductId") ?>" class="" ><?= $record->ProductTitle ?>
                                            <i href="<?= base_url("admin/$this->controller/delete/$record->ProductId") ?>" class="delete-btn fa fa-times pull-right " ></i>  </a> </li>
                                <?php endforeach; ?>
                            </ol>
                        </div>
                    </div>
