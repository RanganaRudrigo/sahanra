...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li><a href="<?= base_url('admin/career') ?>"> Career</a></li>
                            <li class="active"> Career <?= empty($obj->CareerId)?"Create":"Edit" ?> </li>
                        </ol>
            ...
            <div class="row">
                <div class="col-lg-12" > <a href="<?= base_url('admin/career') ?>" class="fa fa-plus btn btn-primary pull-right m_b_10" > Add New </a> </div>
            </div>
            <div class="row">
                <div class="col-sm-8">
                    <?= form_open_multipart() ?>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group" >
                                                ...
                                                <input type="text" id="CareerTitle" name="form[CareerTitle]"
                                                       value="<?= $obj->CareerTitle ?>"
                                                       class="form-control" >
                                            </div>
                ...
                <div class="col-lg-4" >
                    <div class="card-box">
                        <h4 class="header-title m-t-0 m-b-30  ">Career List</h4>
                        <div class="record-list" >
                            <ol id="sortable" >
                                <?php foreach ($records as $record): ?>
                                    <li id="row_<?= $record->CareerId ?>" > <a href="<?= base_url("admin/$this->controller/index/$record->CareerId") ?>" class="" ><?= $record->CareerTitle ?>
                                            <i href="<?= base_url("admin/$this->controller/delete/$record->CareerId") ?>" class="delete-btn fa fa-times pull-right " ></i>  </a> </li>
                                <?php endforeach; ?>
                            </ol>
                        </div>
                    </div>
