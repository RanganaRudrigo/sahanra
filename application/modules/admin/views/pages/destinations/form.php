...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li><a href="<?= base_url('admin/slider') ?>"> Destination</a></li>
                            <li class="active"> Destination <?= empty($obj->DestinationId)?"Create":"Edit" ?> </li>
                        </ol>
            ...
            <div class="row">
                <div class="col-lg-12" > <a href="<?= base_url('admin/destinations') ?>" class="fa fa-plus btn btn-primary pull-right m_b_10" > Add New </a> </div>
            </div>
            <div class="row">
                <div class="col-lg-8">
                    <?= form_open() ?>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group" >
                                                ...
                                                <input type="text" id="DestinationTitle" name="form[DestinationTitle]"
                                                       value="<?= $obj->DestinationTitle ?>"
                                                       class="form-control" >
                                            </div>
                                            <div class="form-group" >
                                                <label for="name"> Location </label>
                                                <input type="text" id="Map" name="form[Map]"
                                                       value="<?= $obj->Map ?>"
                                                       class="form-control" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6" >
                                            <div class="form-group">
                                                <label> Destination Default Image  <small> image size ( 570px * 686px ) </small>  </label>
                                            </div>
                ...
                <div class="col-lg-4" >
                    <div class="card-box">
                        <h4 class="header-title m-t-0 m-b-30  ">Destination List </h4>

                        <div class="record-list" >
                            <ol id="sortable" >
                                <?php foreach ($records as $record): ?>
                                    <li id="row_<?= $record->DestinationId ?>" > <a href="<?= base_url("admin/$this->controller/index/$record->DestinationId") ?>" class="" ><?= $record->DestinationTitle ?>
                                            <i href="<?= base_url("admin/$this->controller/delete/$record->DestinationId") ?>" class="delete-btn fa fa-times pull-right " ></i>  </a> </li>
                                <?php endforeach; ?>
                            </ol>
                        </div>
                    </div>
