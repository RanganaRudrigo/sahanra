...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="active"> Event <?= empty($obj->EventId)?"Create":"Edit" ?> </li>
                        </ol>
            ...
            <div class="row">
                <div class="col-lg-12" > <a href="<?= base_url('admin/events') ?>" class="fa fa-plus btn btn-primary pull-right m_b_10" > Add New </a> </div>
            </div>
            <div class="row">
                <div class="col-lg-8">
                    <?= form_open() ?>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6" >
                                            <div class="form-group">
                                                <label> Event Default Image  <small> image size ( 570px * 686px ) </small>  </label>
                                            </div>
                        ...
                        <div class="record-list" >
                            <ol id="sortable" >
                                <?php foreach ($records as $record): ?>
                                    <li id="row_<?= $record->EventId ?>" > <a href="<?= base_url("admin/$this->controller/index/$record->EventId") ?>" class="" ><?= $record->EventTitle ?>
                                            <i href="<?= base_url("admin/$this->controller/delete/$record->EventId") ?>" class="delete-btn fa fa-times pull-right " ></i>  </a> </li>
                                <?php endforeach; ?>
                            </ol>
                        </div>
                    </div>
