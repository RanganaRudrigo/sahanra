                ...
                <div class="element-item masonry-item col-md-4 col-sm-6 col-xs-12 with-space ">
                    <div class="portfolio-item">
                        <figure class="portfolio-figure">
                            <img src="<?= UP.$gallery->Image ?>" alt="Portfolio Image">
                            <figcaption>
                                <div class="valign-wrap fullwidth fullheight">
                                    <div class="caption-wrap valign-middle">
                                        <h2><?= $gallery->GalleryTitle ?></h2>
                                        <div class="separator"></div>
                                        <p><?= character_limiter($gallery->ShortDescription,200) ?></p>
                                        <a href="<?=  base_url('gallery/'.url_title($gallery->GalleryTitle)."/$gallery->GalleryId") ?>"
