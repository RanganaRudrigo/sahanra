...
<!-- Banner Small Begin -->
<section class="section banner-small parallax-section valign-wrap" style="background: url('<?= UP.$gallery->Image ?>'); background-size: cover;">
    <div class="overlay"></div>
    <div class="content-wrap valign-bottom">
        <div class="container">
            <div class="col-md-12">
                <div class="title wow animated fadeInUp"><h1><?= $gallery->GalleryTitle ?></h1></div>
                <div class="subtitle wow animated fadeIn"><h2><?= $gallery->ShortDescription ?></h2></div>
            </div>
        </div>
    </div><!--/.content-wrap -->
...
<section class="gallery-list">
    <div class="container no-h-padding">
        <div class="isotope-wrap masonry-grid grouped-image-list">
            <?php foreach (json_decode($gallery->MoreImage)  as $k =>  $image): ?>
            <div class="element-item masonry-item col-md-4 col-sm-6 col-xs-12 with-space tripPhoto">
                <figure class="gallery-column margin-responsive">
                    <img src="<?= UPT.$image ?>" alt="">

                    <figcaption>
                        <div class="valign-wrap fullwidth fullheight">
                            <div class="caption-wrap valign-middle">
                                <a href="<?= UP.$image ?>" class="no-effect"><i class="pe-7s-search pe-2x"></i></a>
                            </div><!--/.caption-wrap -->
                        </div>
                    </figcaption>
